...
```{r}
buildTestSet<-function(directory,p) {
...
tt<-buildTestSet(makeFileName(dir.root,dir.test),p)
...
for(i in 1:length(percentages)) {
    ...
    n1GramTable<-read.csv(makeFileName(nGramDirectory,ngramFile.1KN),colClasses = c("character","integer"))
    n2GramTable<-read.csv(makeFileName(nGramDirectory,ngramFile.2KN),colClasses = c("character","character","integer"))
    n3GramTable<-read.csv(makeFileName(nGramDirectory,ngramFile.3),colClasses = c("character","character","integer"))
