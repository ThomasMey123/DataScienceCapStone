...
n2GramTable<-read.csv(paste0(nGramDirectory,"\\shrunk_N2GramsKN.csv"),colClasses = c("character","character","integer"))
n3GramTable<-read.csv(paste0(nGramDirectory,"\\shrunk_N3Grams.csv"),colClasses = c("character","character","integer"))
